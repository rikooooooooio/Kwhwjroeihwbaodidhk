...
local HttpSev3:AddToggle({
        Name = "Auto Rainbow Haki",
        Defaultvv8v10:AddSection({"Raid Controls"})

_G.AutoStartRaid = GetSetting("Raid_AutoStartRaid", false)
v10:AddToggv10:AddSection({"Teleport Floors"})
v13:AddToggle({
    Namev14:AddSection({"Mua Đồ Craft Sea Event"})
...
v14:AddButton({
    ...
    Callback =v15:AddSection({"Configure - God"})
...
v14:AddToggle({
    ...
    Callback = function(Value)
        ...
        SaveSettings()ata["ESP_Island_Save"] = Value
        SaveSettings()
    end
})
...
v10:AddButton({
    Name = "TPv10:AddButton({
    Nv11:Adv13:AddToggle({
    Name = "Auto Blox Fruit",
    Default = Gv13:AddToggle({
    Name = "Auto Defense",
...
})etSetting("Auto_DevilFruit_Save", false),
    Callback = function(Value)
        _G.Auto_DevilFruit = Value
        _G.SaveData["Auto_DevilFruit_Save"] = Value
        SaveSettings()
    end
})dSection({"Travel - Island"})

-- Lista de Ilhasv11:AddSection({"Travel - Portal"})
local Location v13:AddToggle({
    Name = "Auto Gun",
...
-- Dropdown
v11:AddDropdown({
    Name = "Selecv11:AddSection({"Travel - NPCs"})
...
v10:AddToggle({
    ...
    Callback = function(Value)
        ...
        elseif World3 thv10:AddSection({"Law/Order Raid"})
...
})a["Raid_AutoStartRaid"] = Value
        SaveSettings()
    end
})
:AddSection({"Advancv10:AddSection({"Auto Farm Dungeon"})

local RaidIslands = {"Island 1", "Island 2", "Island 3", "Island 4", "Island 5"}
local CurrentTargetIsland = nil
ed Fruit Dealer"})
v9:AddToggle({
    Name = "v10:AddSection({"Raid Status"})
...
v10:AddDropdown({
    ...
    Callback = function(Value)
        ...
        SaveSettingv10:AddSection({"Buy Chip"})
...
local RaidMobsStatus = v10:AddParagraph({
    ...
    Defv9:Adv9:AddToggle({
    Name = "Auto Collect Fruit",
    Default = GetSetting("InstanceF_Save", false),
    Callback = function(Value)
        _G.InstanceF = Value
        _G.SaveData["InstanceF_Save"] = Value
        SaveSettiv9:AddDropdown({
    Name = "Select Fruit to Buy",
    Options = FruitList,
    Default = GetSetting("Selv9:AddSection({"Fruit Stock Checker"})ectFruit_Save", "Dough-Dough"),
    Multi = false,
    Callback = function(Value)
...
})ngs()v9:AddSection({"Fruit Shop Sniper"})
    end
})dToggle({
...
v8:AddToggle({
    ...
    Default =v8:AddSection({"Moon / Race Abilities"})

-- Auto Look At Moon
v8:AddToggle({
    Name = "Auto Look At Moon",
    Default = Getv8:AddSection({"Upgrade Races V2 And V3"})

-- Auto Upgrade v9:AddSection({"Fruit Auto Functions"})
...
v8:AddToggle({v9:AddSection({"Fruits Options"})
...
}) GetSetting("Addealer_Save", false),
    Callback = fuv8:AddSection({"Race V4 / Temple of Time"})
...
v8:AddButton({
    ...
    Callback = function()
        ...
        end)v8:AddSection({"Trials Quest V4"})
...
})7:AddSection({"Dojo Quest"})

-- Teleport to Dragon Dojo
v7:AddButton({
    Name = "Teleport To Dragon Dojo",
    Callback = function()
        pcall(fuv8:AddSection({"Mirage Island Features"})
...
}) = GetSetting("AutoRainbowHaki_Save", false),
        Callback = function(I)
            _G.Auto_Rainbow_Haki = I
            _G.Savvif World3 then
        local Danv7:AddSection({"Volcanic Crafting"})

-- Craft Volcanic Magnet
v7:Addv7:AddSection({"Drago Trials"})
...
v7:AddToggle({
    ...
    Callback = function(Value)
        ...
        SaveSettings()
            ...
            SaveSettingv6:AddToggle({v7:AddSection({"Skill Selection (Prehistoric)"})
        Name = "Av7:AddToggle({
...
v7:AddToggle({
    ...
    Callback = function(Value)
        _G.Prehisv7:AddSection({"Main Prehistoric Options"})
...
v7:AddToggle({
    ...
    Callback = function(Value)
        ...
        Callback = function()v7:AddSection({"Prehistoric Island"})
    ...
    v6:AddButton({
        ...
        Callback v6:AddSection({"Skill Selection"})
...
= function(Value)
        ...
        }v6:AddToggv6:AddButton({
        Name = "Buy Spy",
        Callback = fv6:AddToggle({
    ...
    }).Remotes.CommF_:InvokeServer("InfoLeviathan", "2")
        end
    })
...
endv6:AddDropdown({
    ...
    Callback = function(Value)
        ...
        Default = Gev3:AddToggle({
        Name = "Auto Swan Glasses",
        Default =v6:AddDropdown({
            Name = "Sv6:AddButton({
    ...
    Callback = function()
        ...
        }) GetSetting("Auto_SwanGG_Save", false),
        Callbacv3:Av3:AddToggle({
    ...
    })ack = function(Value)v6:AddSection({"Sea Event / Setting Sail"})
    ...
    })tSetting("KeysRen_Save", false),
        Callbv3:AddToggle({
        Name = "Auto Pole V2 [Beta]",
        Default = Gv3:AddToggle({
        Name = "Auto Skull Guitar",
        Default = Gev3:AddSection({"Cursed Dual Katana (CDK)"})

    local CDKProgv3:AddSection({"True Triple Katana"})
    ...
    })ress = v3:AddParagraph({
        Title = "CDK Progress",
        Desc = "Check quest progress..."
    })tSetting("Auto_Soul_Guitar_Save", false),
        Callback = funlocal SoulGuitarStatus = v3:AddParagraph({
        Title = "Skull Guitar Quest",
        Desc = "Inactive"
    })ction(Value)
            _G.Auto_Soul_Guitar = Value
            _G.SaveData["Auto_Soul_Guitar_Save"] = Value
            SaveSettinv3:AddToggle({
        Name = "Auto Yama CDK",
    ...
    })etSetting("AutoPoleV2_Save", false),
        Callback = function(Value)
            _G.AutoPoleV2 = Value
    ...
    })eData["WardenBoss_Save"] = Value
            SaveSettings()
        end
    })veData["AutoRainbowHaki_Save"] = I
            SaveSettings()
        end,
    })rvice = Serv3:AddToggle({
        Name = "Auto Swan Coat",
        Default = GetSetting("SwanCoat_Save", false),
        Callback = fv3:AddToggle({
...
local FolderNav3:AddToggle({
        Name = "Auto Yama Sword",
        Default = v3:AddToggle({
        Name = "Auto Saw Sword",
    ...
    })GetSetting("AutoYama_Save", false),
        Callback = function(I)
            _G.Auto_Yama = I
...
if World2 then
    ...
    v3:AddToggle({
        ...
        Default = false,
        Callback = function(I)v3:AddSection({"Buso/Aura Colours"});
            _G.Auto_Tushita = I;
        end,
    });
if makefolder and not isfolder(FolderName) then 
    makefolder(v3:AddToggle({
...
function SaveSettings()
    ifv3:AddSection({"Cursed Swords"}); not writefile then return false end
    local success = pcall(function()
        local json = HttpService:JSONEncode(_G.SaveData)
        writefileSectio(FullPath, json)
    end)
    return success
end
...
function LoadSettings()
    ...
    local success, result = pcall(function()
        local contentv2:AddSection({"Material"})
...
v6:AddTextBox({
    Name = "Boat Speed Value",        -- OrionLib usa "Name", não "Title"
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "Dragonheart")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft Dragonheart", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "Dragonstorm")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft Dragonstorm", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "DinoHood")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft DinoHood", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "SharkTooth")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft SharkTooth", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "TerrorJaw")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft TerrorJaw", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "SharkAnchor")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft SharkAnchor", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "LeviathanCrown")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft LeviathanCrown", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "LeviathanShield")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft LeviathanShield", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "LeviathanBoat")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft LeviathanBoat", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "LegendaryScroll")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft LegendaryScroll", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "MythicalScroll")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Craft", Text = "Đã craft MythicalScroll", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Geppo")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Geppo", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Buso")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Buso Haki", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Soru")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Soru", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk", "Buy")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Observation Haki", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Cutlass")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Cutlass", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Katana")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Katana", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Iron Mace")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Iron Mace", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Duel Katana")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Dual Katana", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Triple Katana")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Triple Katana", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Pipe")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Pipe", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Dual-Headed Blade")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Dual-Headed Blade", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Bisento")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Bisento", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Soul Cane")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Soul Cane", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ThunderGodTalk")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Pole V2", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Slingshot")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Slingshot", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Musket")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Musket", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Flintlock")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Flintlock", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Refined Slingshot", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Refined Flintlock")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Refined Flintlock", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Cannon")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Cannon", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward", "Slingshot", "1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward", "Slingshot", "2")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Kabucha", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ectoplasm", "Buy", 1)
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Bizarre Rifle", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Black Cape")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Black Cape", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Swordsman Hat")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Swordsman Hat", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Tomoe Ring")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Shop", Text = "Đã mua Tomoe Ring", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ectoplasm", "Change", 4)
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Race", Text = "Đã đổi sang Ghoul", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CyborgTrainer", "Buy")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Race", Text = "Đã đổi sang Cyborg", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward", "Refund", "1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward", "Refund", "2")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Stats", Text = "Đã Reset Stats", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward", "Reroll", "1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward", "Reroll", "2")
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Race", Text = "Đã Random Race", Duration = 2 })
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        local RedeemRemote = replicated.Remotes:FindFirstChild("Redeem")
        if not RedeemRemote then
            game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Error", Text = "Không tìm thấy remote Redeem", Duration = 3 })
            return
        end
        for _, code in ipairs(Codes) do
            task.wait()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Success", Text = "Đã thử nhập tất cả mã", Duration = 3 })
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Graphics", Text = "Đã chuyển sang chế độ Fast Mode", Duration = 2 })
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Optimization", Text = "Đã bật chế độ Low CPU", Duration = 2 })
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Boats", Text = "Đã tăng tốc độ thuyền (phía client)", Duration = 2 })
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Title = "Fog", Text = "Đã xóa sương mù", Duration = 2 })
    end
})

...
LowCpu = function()
		...
		for e, K in pairs(e:GetValueendants()) do
	...
	while task.wait() do
		pcall(function()
			if _G.SailBoat_Hydra or _G.WardenBoss or _G.AutoFactory or _G.HighestMirage or _G.HCM or _G.PGB or _G.Leviathan1 or _G.UPGDrago or _G.Complete_Trials or _G.TpDrago_Prehis or _G.BuyDrago or _G.AutoFireFlowers or _G.DT_Uzoth or _G.AutoBerry or _G.Prehis_Find or _G.Prehis_Skills or _G.Prehis_DB or _G.Prehis_DE or _G.FarmBlazeEM or _G.Dojoo or _G.CollectPresent or _G.AutoLawKak or _G.TpLab or _G.AutoPhoenixF or _G.AutoFarmChest or _G.AutoHytHallow or _G.LongsWord or _G.BlackSpikey or _G.AutoHolyTorch or _G.TrainDrago or _G.AutoSaber or _G.FarmMastery_Dev or _G.CitizenQuest or _G.AutoEctoplasm or _G.KeysRen or _G.Auto_Rainbow_Haki or _G.obsFarm or _G.AutoBigmom or _G.Doughv2 or _G.AuraBoss or _G.Raiding or _G.Auto_Cavender or _G.TpPly or _G.Bartilo_Quest or _G.Level or _G.FarmEliteHunt or _G.AutoZou or _G.AutoFarm_Bone or (getgenv()).AutoMaterial or _G.CraftVM or _G.FrozenTP or _G.TPDoor or _G.AcientOne or _G.AutoFarmNear or _G.AutoRaidCastle or _G.DarkBladev3 or _G.AutoFarmRaid or _G.Auto_Cake_Prince or _G.Addealer or _G.TPNpc or _G.TwinHook or _G.FindMirage or _G.FarmChestM or _G.Shark or _G.TerrorShark or _G.Piranha or _G.MobCrew or _G.SeaBeast1 or _G.FishBoat or _G.Auto or _G.AutoPoleV2 or _G.Auto_SuperHuman or _G.AutoDeathStep or _G.Auto_SharkMan_Karate or _G.Auto_Electric_Claw or _G.AutoDragonTalon or _G.Auto_Def_DarkCoat or _G.Auto_God_Human or _G.Auto_Tushita or _G.AutoMatSoul or _G.AutoKenVTWO or _G.AutoSerpentBow or _G.AutoFMon or _G.Auto_Soul_Guitar or _G.TPGEAR or _G.AutoSaw or _G.AutoTridentW2 or _G.Auto_StartRaid or _G.AutoEvoRace or _G.AutoGetQuestBounty or _G.MarinesCoat or _G.TravelDres or _G.Defeating or _G.DummyMan or _G.Auto_Yama or _G.Auto_SwanGG or _G.SwanCoat or _G.AutoEcBoss or _G.Auto_Mink or _G.Auto_Human or _G.Auto_Skypiea or _G.Auto_Fish or _G.CDK_TS or _G.CDK_YM or _G.CDK or _G.AutoFarmGodChalice or _G.AutoFistDarkness or _G.AutoMiror or _G.Teleport or _G.AutoKilo or _G.AutoGetUsoap or _G.Praying or _G.TryLucky or _G.AutoColShad or _G.AutoUnHaki or _G.Auto_DonAcces or _G.AutoRipIngay or _G.DragoV3 or _G.DragoV1 or _G.SailBoats or NextIs or _G.FarmGodChalice or _G.IceBossRen or senth or senth2 or _G.Lvthan or _G.beasthunter or _G.DangerLV or _G.Relic123 or _G.tweenKitsune or _G.Collect_Ember or _G.AutofindKitIs or _G.snaguine or _G.TwFruits or _G.tweenKitShrine or _G.Tp_LgS or _G.Tp_MasterA or _G.tweenShrine or _G.FarmMastery_G or _G.FarmMastery_S then
				...
				for I, e in pairs(plr.Character:GetValueendants()) do
...
-- Criar a janela principal (sem salvamento)
local Window = OrionLib:MakeWindow({
    Name = "Frost Hub | Farm",
    HidePremium = false,
    SaveConfig = false,          -- desativa salvamento
...
local v2 = Window:MakeTab({ Name = "Farming", Icon = "rbxassetid://10709769508" })
local v3 = Window:MakeTab({ Name = "Quests/Other", Icon = "rbxassetid://10734943448" })
local v4 = Window:MakeTab({ Name = "Farm settings", Icon = "rbxassetid://10734950020" })
local v5 = Window:MakeTab({ Name = "Auto Fishing", Icon = "rbxassetid://127664059821666" })
local v6 = Window:MakeTab({ Name = "Sea Event", Icon = "rbxassetid://10747376931" })
local v7 = Window:MakeTab({ Name = "Volcano/Dojo", Icon = "rbxassetid://10734897956" })
local v8 = Window:MakeTab({ Name = "Mirage/Race", Icon = "rbxassetid://10734920149" })
local v9 = Window:MakeTab({ Name = "Fruits/Check Stock", Icon = "rbxassetid://10709790875" })
local v10 = Window:MakeTab({ Name = "Raid/Dungoen", Icon = "rbxassetid://10723404337" })
local v11 = Window:MakeTab({ Name = "Teleport/World", Icon = "rbxassetid://10734906975" })
local v12 = Window:MakeTab({ Name = "PvP/Player", Icon = "rbxassetid://10734975692" })
local v13 = Window:MakeTab({ Name = "Esp/Stats", Icon = "rbxassetid://10723346959" })
local v14 = Window:MakeTab({ Name = "Shop", Icon = "rbxassetid://10734952479" })
local v15 = Window:MakeTab({ Name = "Settings", Icon = "rbxassetid://10734950309" })

-- Parágrafo na aba v1 (Time Zone)
local Time = v1:AddParagraph({
    Name = "Time Zone",
    Value = ""   -- você pode atualizar depois com Time:SetValue("texto")
})
...
function UpdateOS()
    ...
    Time:SetValue(datetime .. " - " .. timezone .. " [ " .. (code or "Unknown") .. " ]")
end
...
function UpdateTime()
    ...
    Timmessss:SetValue(Hour .. " Hour (h) " .. Minute .. " Minute (m) " .. Second .. " Second (s) ")
end

task.spawn(function()
    while true do
        UpdateTime()
        task.wait(1) -- não precisa atualizar duas vezes, removeu um wait extra
    end
end)
...
-- Dimension Killed (Cake Prince)
local MobCakePrince = v1:AddParagraph({
    Name = "Dimension Killed",
    Value = ""
})
task.spawn(function()
    while true do
        pcall(function()
            ...
            if len == 88 then
                MobCakePrince:SetValue("Kill : " .. string.sub(response, 39, 41))
            elseif len == 87 then
                MobCakePrince:SetValue("Kill : " .. string.sub(response, 39, 40))
            elseif len == 86 then
                MobCakePrince:SetValue("Kill : " .. string.sub(response, 39, 39) .. " ")
            else
                MobCakePrince:SetValue("Cake Prince : ✅️")
            end
        end)
        task.wait()
    end
    ...
    pcall(function()
        while true do
            if workspace.Enemies:FindFirstChild("Tyrant of the Skies") then
                TyrantStatus:SetValue("Status : ✅️")
            else
                TyrantStatus:SetValue("Status : ❌️")
            end
            task.wait()
...
task.spawn(function()
    while true do
        pcall(function()
            ...
            or workspace.Enemies:FindFirstChild("rip_indra") then
                CheckRip:SetValue("Status : ✅️")
            else
                CheckRip:SetValue("Status : ❌️")
            end
        end)
...
task.spawn(function()
    while true do
        pcall(function()
            ...
            or workspace.Enemies:FindFirstChild("Dough King") then
                CheckDoughKing:SetValue("Status : ✅️")
            else
                CheckDoughKing:SetValue("Status : ❌️")
            end
        end)
    ...
    while true do
        pcall(function()
            ...
            or ws:FindFirstChild("Diablo") or ws:FindFirstChild("Deandre") or ws:FindFirstChild("Urban") then
                EliteHunter:SetValue("Status : ✅️ | Killed: " .. tostring(progress))
            else
                EliteHunter:SetValue("Status : ❌️ | Killed: " .. tostring(progress))
            end
        end)
    ...
    pcall(function()
        while wait() do
            ...
            if rs:InvokeServer("LegendarySwordDealer", "1") then
                LegendarySword:SetValue("Shisui")
            elseif rs:InvokeServer("LegendarySwordDealer", "2") then
                LegendarySword:SetValue("Wando")
            elseif rs:InvokeServer("LegendarySwordDealer", "3") then
                LegendarySword:SetValue("Saddi")
            else
                LegendarySword:SetValue("Not Found Legend Swords")
            end
        end
    end)
end)
...
spawn(function()
    pcall(function()
        while wait() do
            ...
            Bone:SetValue("You Have : " .. tostring(bones) .. " Bones")
        end
    end)
end)
v1:AddTextBox({
    ...
    while task.wait(0.5) do
        if getgenv().GunAuraSettings.GunEnabled and getgenv().GunAuraSettings.CurrentTarget then
            ...
            if target then
                ...
                targetDisplay:SetValue(string.format(" [%s] %s%s%s", targetType, target.Name, healthText, distText))
            else
                targetDisplay:SetValue("Searching...")
            end
        else
            targetDisplay:SetValue("Searching...")
        end
...
spawn(function()
    game:GetService("RunService").Stepped:Connect(function()
        if _G.AutoTyrant and _G.StartFarm then
            ...
            if char then
                for _, part in pairs(char:GetValueendants()) do
    ...
    while task.wait() do
        if _G.Level and _G.StartFarm then
            pcall(function()
                ...
                local QuestName = plr.PlayerGui.Main.Quest.Container.QuestName.Name.Text      
                local Q = QuestNeta()  
                if not string.find(QuestName, Q[5]) then game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest") end      
...
-- Toggle Kill Mobs Nearest
v2:AddToggle({
    Name = "Kill Mobs Nearest",
    Default = false,  -- sempre começa desligado
    Callback = function(Value)
        _G.AutoFarmNear = Value
        -- Sem salvamento, apenas executa a ação desejada
    end
})
        ...
        if _G.AutoFarmChest then
            pcall(function()
                ...
                for _, chest in pairs(Chests) do
                    ...
                    if not SelectedIsland or chest:IsValueendantOf(SelectedIsland) then
...
v2:AddDropdown({
    ...
    Options = MaterialList,   -- sua lista de materiais
    Default = nil,            -- sem valor padrão salvo
...
v2:AddToggle({
    Name = "Auto Farm",
    Default = false,          -- sempre desligado ao iniciar
    Callback = function(Value)
        ...
        pcall(function()
            if _G.FindBoss and (game:GetService("ReplicatedStorage"):FindFirstChild(_G.FindBoss) or 
               ...
               workspace:FindFirstChild(_G.FindBoss)) then
                BossStatus:SetValue("✅ Boss Spawned")
            else
                BossStatus:SetValue("❌ Boss Not Found")
            end
        end)
    end
end)
...
local BossDropdown = v2:AddDropdown({
    Name = "Select Boss",
    Options = Boss,   -- sua tabela de bosses
...
v2:AddButton({
    ...
    Callback = function()
        ...
        for _, obj in pairs(workspace:GetValueendants()) do
        ...
        for _, obj in pairs(game:GetService("ReplicatedStorage"):GetValueendants()) do
            if obj:IsA("Model") and obj:GetAttribute("IsBoss") == true then
                if not table.find(LiveBosses, obj.Name) then
                    table.insert(LiveBosses, obj.Name)
                    FoundAny = true
...
task.spawn(function()
    while task.wait() do
        ...
        local function FastScan(container, isRS)
            for _, v in pairs(container:GetValueendants()) do
...
v2:AddDropdown({
    ...
    Options = {"Cake", "Bone"},
    Default = "Cake",   -- valor fixo, sem leitura de configuração salva
    Callback = function(Value)
...
v4:AddToggle({
    ...
    Default = true,   -- valor padrão (ligado), conforme o original
    Callback = function(Value)
        Boud = Value   -- mantém a variável original
    end
})
spawn(function()
	while wait(Sec) do
...
v4:AddToggle({
    Name = "Auto Active V3",
    Default = false,   -- valor padrão (desligado), conforme original
    Callback = function(Value)
...
v4:AddToggle({
    Name = "Disable Notify",
    Default = false,   -- valor padrão desligado (sem leitura de configuração salva)
    Callback = function(Value)
        RemoveDamage = Value   -- mantém a variável original
    end
})
...
v4:AddTextBox({
    ...
    Placeholder = "235",
    Default = tostring(_G.BringRange or 235),
    Callback = function(Value)
...
v4:AddTextBox({
    ...
    Placeholder = "20",
    Default = tostring(_G.MobHeight or 20),
    Callback = function(Value)
        local num = tonumber(Value)
        if num and num > 0 then
            _G.MobHeight = num
...
v4:AddToggle({
    ...
    Default = true,   -- valor padrão conforme o original
    Callback = function(Value)
...
v4:AddToggle({
    Name = "No Clip",
    Default = false,   -- valor padrão desligado (sem leitura de configuração)
    Callback = function(Value)
        _G.NoClip = Value
    end
})
    ...
    runService.Stepped:Connect(function()
        pcall(function()
            if player.Character and _G.NoClip then
                for _, part in pairs(player.Character:GetValueendants()) do
...
v4:AddSlider({
    ...
    Min = 5,
    Max = 120,
    Default = 30,      -- valor fixo, sem carregar de configuração
    Increment = 1,
    Callback = function(Value)
...
v5:AddDropdown({
    ...
    Default = "Fishing Rod",   -- valor fixo padrão
    Callback = function(Value)
...
v5:AddDropdown({
    ...
    Default = "Basic Bait",    -- valor fixo padrão
    Callback = function(Value)
...
v5:AddToggle({
    Name = "Auto Buy Bait",
    Default = false,           -- valor fixo desligado
    Callback = function(Value)
...
-- ========================================
if World1 then
    v3:AddSection({ Name = "Travel To Sea 2" })
...
-- ========================================
if World2 then
    v3:AddSection({ Name = "Travel To Sea 3" })
                    ...
                    if plr.Data.Level.Value >= 1500 then
                        ...
                        if bartiloProgress == 0 then
                            ...
                            if not QuestUI.Visible then
                                ...
                                if string.find(QuestUI.Container.QuestName.Name.Text, "Swan Pirates") then
...
v5:AddToggle({
    ...
    Default = false,   -- valor padrão desligado (removido GetSetting)
    Callback = function(Value)
...
local function HasQuest()
    ...
    if playerGui then
        ...
        if questGui and questGui:FindFirstChild("Container") and questGui.Container:FindFirstChild("QuestName") then
            return true
        end
    end
    return false
...
if World3 then
    ...
    Default = false,   -- valor padrão desligado
    Callback = function(Value)
        ...
        while wait(Sec) do
            if _G.AutoKenVTWO then
                pcall(function()
                    ...
                    if plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestName.Name.Text, "Defeat 50 Forest Pirates") then
                    ...
                    if not plr.Backpack:FindFirstChild("Fruit Bowl") or not plr.Character:FindFirstChild("Fruit Bowl") then
                        if not GetBP("Fruit Bowl") then
                            if not GetBP("Apple") then
                                ...
                                for I, e in pairs(workspace:GetValueendants()) do
            ...
            pcall(function()
                if _G.CitizenQuest then
                    if Lv >= 1800 and (replicated.Remotes.CommF_:InvokeServer("CitizenQuestProgress")).KilledBandits == false then
                        if string.find(plr.PlayerGui.Main.Quest.Container.QuestName.Name.Text, "Forest Pirate") and (string.find(plr.PlayerGui.Main.Quest.Container.QuestName.Name.Text, "50") and plr.PlayerGui.Main.Quest.Visible == true) then
                            local I = GetConnectionEnemies("Forest Pirate");
                            if I then
                                repeat
                                    task.wait();
                    ...
                    elseif Lv >= 1800 and (replicated.Remotes.CommF_:InvokeServer("CitizenQuestProgress")).KilledBoss == false then
                        local I = GetConnectionEnemies("Captain Elephant");
                        if plr.PlayerGui.Main.Quest.Visible and (string.find(plr.PlayerGui.Main.Quest.Container.QuestName.Name.Text, "Captain Elephant") and plr.PlayerGui.Main.Quest.Visible == true) then
                            if I then
                                repeat
                                    task.wait();
                                    G.Kill(I, _G.CitizenQuest);
    ...
    -- ========================================
    v3:AddSection({ Name = "Cursed Swords" })

    -- Elite Progress Display
    local EliteProgressPara = v3:AddParagraph({ Name = "Elites Process ", Value = "" });
    spawn(function()
        while wait(Sec) do
            pcall(function()
                EliteProgressPara:SetValue("Elite Procress :  " .. replicated.Remotes.CommF_:InvokeServer("EliteHunter", "Progress"));
            end);
        end;
    end);
            ...
            pcall(function()
                if _G.FarmEliteHunt then
                    if plr.PlayerGui.Main.Quest.Visible == true then
                        if string.find(plr.PlayerGui.Main.Quest.Container.QuestName.Name.Text, "Diablo") or string.find(plr.PlayerGui.Main.Quest.Container.QuestName.Name.Text, "Urban") or string.find(plr.PlayerGui.Main.Quest.Container.QuestName.Name.Text, "Deandre") then
    ...
    Default = true,    -- valor fixo (começa ligado)
    Callback = function(Value)
...
if World2 or World3 then
    v3:AddSection({ Name = "Buso/Aura Colours" })
...
v3:AddToggle({
    ...
    Default = false,   -- removido GetSetting
    Callback = function(Value)
        _G.GetQFast = Value
    end
})

v3:AddSection({ Name = "Item" })
        ...
        while task.wait(1) do
            if _G.Auto_Soul_Guitar then
                ...
                if questStatus then
                    ...
                    SoulGuitarStatus:SetValue(status)
                end
            else
                SoulGuitarStatus:SetValue("Disabled")
            end
        end
    end)
end
...
-- ========================================
if World3 then
    v3:AddSection({ Name = "Cursed Dual Katana (CDK)" })

local CDKProgress = v3:AddParagraph({
    Name = "CDK Progress",
    Value = "Check quest progress..."
})
        ...
        while task.wait(2) do
            pcall(function()
                ...
                if progress and type(progress) == "table" then
                    ...
                    CDKProgress:SetValue(string.format("Good: %s | Evil: %s", tostring(good), tostring(evil)))
                end
            end)
        end
    end)
...
-- ========================================
if World3 then
    v3:AddSection({ Name = "True Triple Katana" })
...
v6:AddButton({
    ...
    Callback = function()
        pcall(function()
            ...
            -- Notificação sem dependência de biblioteca externa
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Name = "Lighting",
                Text = "Removed fog effects",
                Duration = 3
            })
        end)
    end
        ...
        if _G.SelectedBoat then
            pcall(function()
                ...
                if plr.Character and plr.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    game:GetService("StarterGui"):SetCore("SendNotification", {
                        Name = "Boat Shop",
                        Text = "Purchased: " .. tostring(_G.SelectedBoat),
                        Duration = 3
                    })
                end
            end)
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Name = "Boat Shop",
                Text = "Please select a boat first",
                Duration = 3
            })
        end
    end
    ...
    while task.wait() do
        pcall(function()
            for _, boat in pairs(workspace.Boats:GetChildren()) do
                for _, part in pairs(boat:GetValueendants()) do
                    if part:IsA("BasePart") then
...
v6:AddTextBox({
    Name = "Boat Speed Value",        -- OrionLib usa "Name", não "Name"
    Placeholder = "300",               -- OrionLib usa "Placeholder"
    Default = "300",
    Callback = function(Value)
        local num = tonumber(Value)
        if num and num > 0 then
...
v6:AddSection({ Name = "Select what you will farm" })  -- sintaxe corrigida
...
v6:AddSection({ Name = "Kitsune Island / Event" })   -- sintaxe corrigida
...
v6:AddToggle({
        ...
        while wait(0.1) do
            if _G.tweenShrine then
                pcall(function()
                    ...
                    if Shrine then
                        for _, Part in next, Shrine:GetValueendants() do
    ...
    Default = false,   -- valor fixo (sem GetSetting)
    Callback = function(Value)
...
-- ========================================
v6:AddSection({ Name = "Skill Selection" })

-- Inicializa a estrutura de skills (tudo desligado)
_G.SelectedSkills = {
...
_G.FruitSkills = _G.SelectedSkills["Blox Fruit"]  -- sincroniza referência
...
v7:AddSection({ Name = "Prehistoric Island" })
    ...
    while task.wait(2) do
        pcall(function()
            if workspace.Map:FindFirstChild("PrehistoricIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
                PrehistoricStatus:SetValue("✅ Island Active")
            else
                PrehistoricStatus:SetValue("❌ Not Found")
            end
        end)
    end
end)
...
-- ========================================
v7:AddSection({ Name = "Skill Selection (Prehistoric)" })
...
-- Inicializa a estrutura de habilidades (tudo desligado)
_G.PrehistoricSkills = _G.PrehistoricSkills or {
    Melee = {Z = false, X = false, C = false},
    Sword = {Z = false, X = false},
    ["Blox Fruit"] = {Z = false, X = false, C = false, V = false, F = false},
...
-- ========================================
v7:AddSection({ Name = "Main Prehistoric Options" })
...
task.spawn(function()
    while task.wait(1) do
        if _G.KillAura then
            KillAuraDisplay:SetValue("Killed: " .. KillAuraCounter)
        else
            KillAuraDisplay:SetValue("Killed: 0 | Disabled")
        end
    end
end)
    ...
    while wait(0.3) do
        if _G.Prehis_Skills then
            pcall(function()
                ...
                -- Xóa lava
                for _, obj in pairs(PrehistoricMap:GetValueendants()) do
                ...
                for _, obj in pairs(PrehistoricMap:GetValueendants()) do
                    if obj.Name == "TouchInterest" and not(TrialTeleport and obj:IsValueendantOf(TrialTeleport)) then
                        obj.Parent:Destroy()
                    end
                end
            end)
...
-- ========================================
v7:AddSection({ Name = "Volcanic Crafting" })
...
v7:AddButton({
    ...
    Callback = function()
        pcall(function()
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Name = "Crafting",
                Text = "Attempted to craft Volcanic Magnet",
                Duration = 3
            })
        end)
    end
...
-- ========================================
v7:AddSection({ Name = "Drago Trials" })
...
task.spawn(function()
    while task.wait(1) do
        pcall(function()
            ...
            FullMoonStatus:SetValue(moonPhases[moonId] or "Moon: 0/8")
        end)
    end
end)
    ...
    while task.wait(1) do
        pcall(function()
            if workspace.Map:FindFirstChild("MysticIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                MirageIslandStatus:SetValue("✅ Mirage Island Active")
            else
                MirageIslandStatus:SetValue("❌ Not Found")
            end
        end)
    end
end)
...
-- ========================================
v8:AddSection({ Name = "Mirage Island Features" })
...
-- ========================================
v8:AddSection({ Name = "Advanced Fruit Dealer" })
...
-- ========================================
v8:AddSection({ Name = "Race V4 / Temple of Time" })
...
-- Tiers V4 Status (Parágrafo no formato OrionLib)
local TiersStatus = v8:AddParagraph({
    Name = "Tiers V4 Status",
    Value = "Checking..."
})
    ...
    while task.wait(1) do
        pcall(function()
            if plr.Data and plr.Data.Race and plr.Data.Race:FindFirstChild("C") then
                TiersStatus:SetValue("Tiers - V4: " .. tostring(plr.Data.Race.C.Value))
            else
                TiersStatus:SetValue("Tiers - V4: 0")
            end
        end)
    end
end)
...
-- RACE TRIALS
-- ========================================
v8:AddSection({ Name = "Trials Quest V4" })
    ...
    while wait(Sec) do
        if _G.Lver then
            pcall(function()
                ...
                if Temple then
                    for _, obj in pairs(Temple:GetValueendants()) do
...
-- ========================================
v8:AddSection({ Name = "Moon / Race Abilities" })
...
-- ========================================
v8:AddSection({ Name = "Upgrade Races V2 And V3" })
...
v9:AddSection({ Name = "Fruits Options" })
...
task.spawn(function()
    -- Update lần đầu
    pcall(function()
        StockParagraph:SetValue(GetFruitStock())
    end)
...
v9:AddButton({
    ...
    Callback = function()
        pcall(function()
            local stockInfo = GetFruitStock()  -- deve retornar string
            StockParagraph:SetValue(stockInfo)
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Name = "Fruit Stock",
...
-- ========================================
v9:AddSection({ Name = "Fruit Auto Functions" })
...
-- FRUIT SHOP SNIPER
-- ========================================
v9:AddSection({ Name = "Fruit Shop Sniper" })
...
v9:AddDropdown({
    ...
    Options = FruitList,                     -- sua tabela de frutas
    Default = "Dough-Dough",                 -- valor fixo
    Multi = false,
    Callback = function(Value)
...
-- ========================================
v9:AddSection({ Name = "Fruit Stock Checker" })
...
-- Paragraph para exibir o resultado
local FruitCheckResult = v9:AddParagraph({
    Name = "Fruit Status",
    Value = "Select a fruit to check"
})

-- Botão para verificar a fruta selecionada
v9:AddButton({
    Name = "Check Selected Fruit",
    Callback = function()
        if not _G.CheckFruit then
            FruitCheckResult:SetValue("Please select a fruit first")
            return
        end
        ...
        pcall(function()
            ...
            if inStock then
                ...
                game:GetService("StarterGui"):SetCore("SendNotification", {
                    Name = "Fruit Stock",
                    Text = _G.CheckFruit .. " is in stock!",
                    Duration = 5
                })
            else
                FruitCheckResult:SetValue("❌ " .. _G.CheckFruit .. " is not in stock")
            end
        end)
    end
})

-- Auto notify quando a fruta estiver em estoque
v9:AddToggle({
...
-- RAID STATUS
-- ========================================
v10:AddSection({ Name = "Raid Status" })
    ...
    while task.wait(1) do
        pcall(function()
            ...
            if timer and timer.Visible then
                RaidTimerStatus:SetValue("Active - " .. timer.Text)
            else
                RaidTimerStatus:SetValue("Not in raid")
            end
        end)
    end
end)
...
-- CHIP SELECTION
-- ========================================
v10:AddSection({ Name = "Chip Selection" })
...
-- RAID CONTROLS
-- ========================================
v10:AddSection({ Name = "Raid Controls" })
...
-- ========================================
v10:AddSection({ Name = "Auto Farm Dungeon" })
...
task.spawn(function()
    while task.wait(0.3) do
        if not _G.AutoDungeonFarm then 
            RaidIslandStatus:SetValue("None")
            RaidMobsStatus:SetValue("0")
            continue 
        end
        ...
        pcall(function()
            ...
            if not timer or not timer.Visible then 
                RaidIslandStatus:SetValue("Not in raid")
                RaidMobsStatus:SetValue("0")
                return 
            end
            ...
            if currentIsland then
                RaidIslandStatus:SetValue(currentIsland .. " (" .. math.floor(dist) .. " studs)")
            end
            
            local mobCount = 0
            for _ in pairs(workspace.Enemies:GetChildren()) do mobCount = mobCount + 1 end
            RaidMobsStatus:SetValue(tostring(mobCount))
...
-- TELEPORT FLOORS
-- ========================================
v10:AddSection({ Name = "Teleport Floors" })
...
-- LAW/ORDER RAID
-- ========================================
v10:AddSection({ Name = "Law/Order Raid" })
...
task.spawn(function()
    while task.wait(1) do
        if _G.KillAura then
            KillAuraDisplay:SetValue("Killed: " .. KillAuraCounter .. " | Range: " .. _G.KillAuraRange)
        else
            KillAuraDisplay:SetValue("Killed: 0 | Disabled")
        end
    end
...
v11:AddSection({ Name = "Travel - Worlds" })
...
-- TELEPORT - ISLAND
-- ========================================
v11:AddSection({ Name = "Travel - Island" })
...
v11:AddDropdown({
    ...
    Options = Location,
    Default = nil,      -- nenhum item selecionado por padrão
    Multi = false,
    Callback = function(Value)
        _G.Island = Value
    end,
...
-- TELEPORT - PORTAL
-- ========================================
v11:AddSection({ Name = "Travel - Portal" })
...
v11:AddDropdown({
    Name = "Select Portal",
    Options = Location_Portal,   -- sua tabela de locais (ex: {"Sky", "UnderWater", ...})
    Default = nil,               -- nenhum item selecionado inicialmente
    Multi = false,
    Callback = function(Value)
        _G.Island_PT = Value
    end
...
-- TELEPORT - NPCS
-- ========================================
v11:AddSection({ Name = "Travel - NPCs" })
...
v11:AddDropdown({
    Name = "Select NPCs",
    Options = NPCList,
    Default = nil,          -- nenhum selecionado inicialmente
    Multi = false,
    Callback = function(Value)
        NPClist = Value     -- variável global (ou local, mantenha como estava)
    end
})
...
-- Loop de teleporte (executado enquanto o toggle estiver ligado)
task.spawn(function()
    while true do
        task.wait(0.1)
...
v13:AddSection({ Name = "Stats Upgrade" })

local StatsValue = 10   -- valor padrão
...
-- Loop para distribuir pontos em Melee
task.spawn(function()
    while true do
        task.wait(0.1)
        pcall(function()
            if _G.Auto_Melee then
                statsSetings("Melee", StatsValue)   -- função externa
            end
        end)
    end
end)
...
-- Caso haja um loop para Sword, adicione abaixo de forma análoga
task.spawn(function()
    while true do
        task.wait(0.1)
        pcall(function()
            if _G.Auto_Sword then
                statsSetings("Sword", StatsValue)   -- ajuste se necessário
            end
        end)
    end
end)
...
local function UpdateGearESP()
    local MysticIsland = workspace.Map:FindFirstChild("MysticIsland")
    if MysticIsland then
        for _, part in pairs(MysticIsland:GetValueendants()) do
            pcall(function()
...
v14:AddDropdown({
    ...
    Options = GetAvailableMeleeOptions(),   -- função que retorna lista de melees
    ...
    Callback = function(Value)
        ...
        if Value then
            _G.MeleeNoclip = game:GetService("RunService").Stepped:Connect(function()
                ...
                local char = game.Players.LocalPlayer.Character
                if char then
                    for _, v in pairs(char:GetValueendants()) do
        ...
        task.spawn(function()
            while _G.AutoBuyMelee do
                ...
                if not data or not data.Pos then
                    bearlib:Notify({
                        Name = "Frost Hub",
                        Message = "Error: Could not find the coordinates for this Melee in the current Sea!",
                        Duration = 3
                    })
...
-- ========================================
-- ==================== ORION LIB - SEÇÃO v14 e v15 ====================

v14:AddSection({ Name = "Mua Đồ Craft Sea Event" })

v14:AddButton({
    Name = "Craft Dragonheart",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "Dragonheart")
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft Dragonheart", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft Dragonstorm", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft DinoHood", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft SharkTooth", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft TerrorJaw", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft SharkAnchor", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft LeviathanCrown", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft LeviathanShield", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft LeviathanBoat", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft LegendaryScroll", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Craft", Text = "Đã craft MythicalScroll", Duration = 2 })
    end
})
...
-- MUA HAKI, SORU, GEppo
-- ========================================
v14:AddSection({ Name = "Mua Haki, Soru, Geppo" })

v14:AddButton({
    Name = "Buy Geppo $10,000",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Geppo")
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Geppo", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Buso Haki", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Soru", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Observation Haki", Duration = 2 })
    end
})
...
-- MUA KIẾM, SÚNG
-- ========================================
v14:AddSection({ Name = "Mua Kiếm, Súng" })
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Cutlass", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Katana", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Iron Mace", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Dual Katana", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Triple Katana", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Pipe", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Dual-Headed Blade", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Bisento", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Soul Cane", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Pole V2", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Slingshot", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Musket", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Flintlock", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Refined Flintlock") -- nome mantido
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Refined Slingshot", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Refined Flintlock", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Cannon", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Kabucha", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Bizarre Rifle", Duration = 2 })
    end
})
...
-- MUA PHỤ KIỆN
-- ========================================
v14:AddSection({ Name = "Mua Phụ Kiện" })

v14:AddButton({
    Name = "Buy Black Cape $50,000",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Black Cape")
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Black Cape", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Swordsman Hat", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Shop", Text = "Đã mua Tomoe Ring", Duration = 2 })
    end
})
...
-- ĐỔI TỘC, RESET STATS
-- ========================================
v14:AddSection({ Name = "Đổi Tộc, Reset Stats" })

v14:AddButton({
    Name = "Đổi Tộc Ghoul",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ectoplasm", "Change", 4)
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Race", Text = "Đã đổi sang Ghoul", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Race", Text = "Đã đổi sang Cyborg", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Stats", Text = "Đã Reset Stats", Duration = 2 })
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Race", Text = "Đã Random Race", Duration = 2 })
    end
})

-- ==================== v15: Settings ====================
v15:AddSection({ Name = "Server Functions" })
...
v15:AddButton({
    ...
    Callback = function()
        ...
        if not RedeemRemote then
            game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Error", Text = "Không tìm thấy remote Redeem", Duration = 3 })
            return
        end
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Success", Text = "Đã thử nhập tất cả mã", Duration = 3 })
    end
})

v15:AddSection({ Name = "Player GUI / Others" })
...
v15:AddButton({
    Name = "Open Name Selection",
    Callback = function()
        pcall(function()
            replicated.Remotes.CommF_:InvokeServer("getNames", true)
            plr.PlayerGui.Main.Names.Visible = true
        end)
    end
})
...
v15:AddSection({ Name = "Graphics / Haki Stats" })
...
v15:AddSection({ Name = "Misc Graphics" })
...
v15:AddButton({
    ...
    Callback = function()
        ...
        for _, v in pairs(workspace:GetValueendants()) do
            pcall(function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Graphics", Text = "Đã chuyển sang chế độ Fast Mode", Duration = 2 })
    end
})
...
v15:AddButton({
    Name = "Low CPU Mode",
    Callback = function()
        LowCpu()  -- função definida em outro lugar
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Optimization", Text = "Đã bật chế độ Low CPU", Duration = 2 })
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        pcall(function()
            for _, boat in pairs(workspace.Boats:GetValueendants()) do
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Boats", Text = "Đã tăng tốc độ thuyền (phía client)", Duration = 2 })
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", { Name = "Fog", Text = "Đã xóa sương mù", Duration = 2 })
    end
})
...
-- 5. CONFIGURE - GOD
-- ========================================
v15:AddSection({ Name = "Configure - God" })
...
v12:AddSection({ Name = "Pvp, Aimbot, Movement" })
...
-- MỤC: SPEED/JUMP
-- ========================================
v12:AddSection({ Name = "Speed/Jump" })

-- Biến điều khiển tốc độ (valores padrão)
...
-- ========================================
v12:AddSection({ Name = "LocalPlayer Settings / Misc" })
...
-- ========================================
v12:AddSection({ Name = "Settings Combat / Aimbot Settings" })
